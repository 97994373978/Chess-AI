...
dark_block = pygame.image.load('assets/JohnPablok Cburnett Chess set/128px/dark.png')
light_block = pygame.image.load('assets/JohnPablok Cburnett Chess set/128px/light.png')
...
def initialize():
    global screen
    pygame.init()
    pygame.display.set_caption('Chessical')
